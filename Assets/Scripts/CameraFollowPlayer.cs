...
public class CameraFollow : MovingObject
{
    ...
    public float spaceBeyond = 50; //space cam is allowed to move slightly beyond walls (to reveal blank space in beyond)
    ...
    protected override void FixedUpdate()
    {
        if (active && timestepToggle)
        {
            ...
            objCollider.Raycast(Vector2.up, upHits, Global.MainCanvasHeight, layerMaskIndex);
            objCollider.Raycast(Vector2.down, downHits, Global.MainCanvasHeight, layerMaskIndex);
            objCollider.Raycast(Vector2.left, leftHits, Global.MainCanvasHeight, layerMaskIndex);
            objCollider.Raycast(Vector2.right, rightHits, Global.MainCanvasHeight, layerMaskIndex);
